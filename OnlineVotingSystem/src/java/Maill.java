...
public class Maill {  
    ...
    private String FROM_ADDRESS = "bhoomi.desai21@gmail.com";  
    private String PASSWORD = "bhoomi2195";  
    private String FROM_NAME = "Bhoomi";  
    ...
    public boolean sendMail(String[] recipients, String[] bccRecipients, String subject, String message) {  
        try {  
            ...
            Logger.getLogger(Maill.class.getName()).log(Level.SEVERE, null, ex);  
            return false;  
